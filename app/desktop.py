...
def _set_app_name() -> None:
    ...
    try:
        ...
        info["CFBundleName"] = "agent_office"
        info["CFBundleDisplayName"] = "agent_office"
    except Exception:
...
def main() -> None:
    ...
    window = webview.create_window("agent_office", url, width=1380, height=900, min_size=(1000, 680),
